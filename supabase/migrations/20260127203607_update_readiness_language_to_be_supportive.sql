/*
  ...
  ## Changes
  - Updates Ace Hardware onboarding request AI summary to use "new to EDI" instead of "limited EDI experience"
...
-- Update Ace Hardware request to use more supportive language
...
-- Update Tractor Supply Co. request to focus on scope refinement rather than gaps
UPDATE onboarding_requests
SET 
